...
class editPersonalInformationElderly extends StatefulWidget {
  ...
  @override
  State<editPersonalInformationElderly> createState() => _editProfileState();
}

class _editProfileState extends State<editPersonalInformationElderly> {
  // create formkey
                    ...
                    children: [
                      ...
                      Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            TextFormField(
                              initialValue: widget.personal.name,
                            ...
                            TextFormField(
                              initialValue: widget.personal.icNumber,
                              decoration: const InputDecoration(
                            ...
                            TextFormField(
                              initialValue: widget.personal.address,
                              decoration: const InputDecoration(
                                  hintText: 'Address',
                                  labelText: 'Address',
                                  labelStyle:
                            ...
                            TextFormField(
                              initialValue: widget.personal.emergencyNumber,
                              decoration: const InputDecoration(
