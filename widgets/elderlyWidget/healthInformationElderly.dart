...
import 'package:seniorconnect/screens/addScreen/add_health_information_elderly.dart';
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                onTap: () {
                                 ...
                                 editHealthInformationElderly(personal: 
                                 healthInformationElderly(
                                  height:  double.parse(DocData['height']), 
                                  weight: double.parse(DocData['weight']), 
                                  bloodType: DocData['bloodType'], 
                                  allergies: DocData['allergies'], 
                                  covidVaccines: DocData['covidVaccine'], 
                                  chronicDisease: [DocData['disease']])),));
                                },
                              )
                            ],
                          ),
                      ...
                      Table(
                        ...
                        children: [
                          ...
                          TableRow(children: [
                            ...
                            tableRow( (double.parse(DocData['weight']) / (double.parse(DocData['height'])  * double.parse(DocData['height']))).toStringAsFixed(2) ),
                          ]),
                          TableRow(children: [
                            tableRow('2'),
                            tableRow('Weight (kg)'),
